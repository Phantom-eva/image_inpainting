...
def test_quality():
    #path = "C:\Users\happy\Desktop\sesult\prais1"
 ...
 #   file_names = [("00" + str(i+1))[-3:] + "_im" for i in range(100)]
    ...
    '''for name in file_names:
        ...
        imageA = rec_img'''
    for i in range(25):
        imageA = cv2.imread("D:\STUDY\image_inpainting/net_result\Pconv+Nvidiamask/20%\pconv/230000/fake/fake_{:d}.jpg".format(i + 1))
        imageB = cv2.imread("D:\STUDY\image_inpainting/net_result\Pconv+Nvidiamask/20%\pconv/230000/real/real_{:d}.jpg".format(i + 1))
